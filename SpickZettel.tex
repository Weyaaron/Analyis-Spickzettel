...
colorlinks=false, 
pdftitle={Analyis-Spickzettel}
pdfauthor={Aaron Wey, Annabella Gethke}
...
\begin{minipage}[t]{210mm} % The size and alignment of the title
    \section*{Cheatsheet Analysis für InformatikerInnen- Grundlagen}
...
\put(10,200){ % Position on the page to put the title
\begin{minipage}[t]{210mm} % The size and alignment of the title
    \section*{Cheatsheet Analysis für InformatikerInnen- Ungleichungen, Limites}
...
\begin{minipage}[t]{85mm} % Create a box to house text
    ...
    \command{Dreiecksungleichung: \[ {\displaystyle |x \pm y| \leq |x| \pm |y|}\] }{}
    \command{Satz von Eudoxos: \[ {\displaystyle \forall x>0 \exists n\in\mathbb{N}: \frac{1}{n} < x}\] }{}
\end{minipage} % End the first column of text
} % End the first division of the page
%----------------------------------------------------------------------------------------
%	SECOND COLUMN SPECIFICATION 
...
\footnotesize{
Created by Aaron Wey, Annabella Gethke. Last updated \today \\
